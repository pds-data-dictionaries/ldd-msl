<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:msl  Version:1.2.0.0 - Wed Jan 17 16:34:35 UTC 2024 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="msl:SAM_Parameters/msl:sam_gc_column_number">
      <sch:assert test="if (not(@xsi:nil eq 'true') and (not(. = ('1', '2', '3', '4', '5', '6')))) then false() else true()">
        <title>msl:SAM_Parameters/msl:sam_gc_column_number/msl:sam_gc_column_number</title>
        The attribute msl:SAM_Parameters/msl:sam_gc_column_number must be nulled or equal to one of the following values '1', '2', '3', '4', '5', '6'.</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
